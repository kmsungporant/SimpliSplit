...
custom_config = r'--psm 1 --oem 3 -c load_system_dawg=0 -c load_freq_dawg=0'
# print(pytesseract.image_to_string(Image.open('canes.jpg'), config= custom_config, lang='eng'))
...
def create_image_url(filepath):
    ...
    return f'http://localhost:8081/data/upload/{filename}'
